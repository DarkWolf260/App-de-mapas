        ...
        return (
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
              <div style={{ fontWeight: 800, fontSize: "11.5px", display: "flex", alignItems: "center", gap: "5px", color: "#ffffff", textShadow: "0 1px 2px rgba(0,0,0,0.5)" }}>
                <span
                  style={{
              ...
              {lbl.activityNotes && lbl.activityNotes.length > 0 && !lbl.customActivities?.some((a) => !!a.description) && isTitleExpanded && (
                <div
                  style={{
                    fontWeight: 600,
                    fontSize: "9px",
              ...
              {(!!lbl.prehospitalCount || !!lbl.transfersCount || !!lbl.rescuedCount || !!lbl.recoveredCount || !!lbl.rescuedPetsCount || (lbl.customActivities && lbl.customActivities.length > 0)) && (
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px", marginTop: "4px" }}>
                  <div style={{ display: "flex", gap: "4px", fontSize: "8.5px", fontWeight: 700, flexWrap: "wrap", justifyContent: "center" }}>
                    {!!lbl.rescuedCount && (
                    ...
                    {lbl.customActivities?.map((act) => {
                      ...
                      return (
                        ...
                        >
                          <span>{act.name}: {act.value}</span>

                          {/* Solo la flecha al lado del nombre de la actividad en la insignia */}
                          {hasDesc && (
