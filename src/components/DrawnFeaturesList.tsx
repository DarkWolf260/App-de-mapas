...
interface DrawnFeaturesListProps {
  ...
  collapsedChildren: Record<number | string, boolean>;
  onToggleGroupCollapse: (type: string) => void;
  onToggleChildrenCollapse: (polyId: number | string) => void;
  onToggleFeatureVisibility: (id: number | string) => void;
  onToggleFeaturesVisibility: (ids: (number | string)[], visible: boolean) => void;
